...
<div class="max_width_theme order_fast">
    <h1 class="page_title">
        Оформление заказа
    </h1>
    <div class="basket_items">
        <div class="order_info">
            ...
            <div class="contact_info">
                <div class="title">
                    <div class="icon">
                        <img src="assets/svg/contact_info.svg" alt="" class="svg">
                    </div>
                    Контактная информация
                </div>
                <div class="text">
                    Укажите номер телефона и наш оператор<br>
                    перезвонит вам в течении 5 минут
                </div>
                <form action="">
                    <input type="text" class="phone" placeholder="Телефон">
                    <input type="submit" class="btn_green" value="Продолжить">
                </form>
            </div>
        </div>
        <div class="right_block">
            <div class="order_block_reg">
                <p>Пройдите регистрацию и получите бонусы</p>
                <a href="" class="btn_green">Пройти регистрацию</a>
                <img src="assets/img/379ba69de10af702a5264dd9e37d5c278f3b1e47.webp" alt="">
            </div>
            <div class="order_total">
                ...
                <div class="info_fast_cart">
                    <p>
                        <img src="assets/svg/info_fast_cart_1.svg" alt="">
                        Безопасная оплата
                    </p>
                    <p>
                        <img src="assets/svg/info_fast_cart_2.svg" alt="">
                        Бесплатная доставка
                    </p>
                    <p>
                        <img src="assets/svg/info_fast_cart_3.svg" alt="">
                        Бесплатная доставка
                    </p>
                </div>
            </div>
