...
<div class="max_width_theme main_tabs">
    ...
    <div class="tabs_products">
        <div class="tabs_container">
            <ul>
                <li data-tab-id="" class="active">Новинки</li>
                <li data-tab-id="">Хит продаж</li>
                <li data-tab-id="">Мы рекомендуем</li>
                <li data-tab-id="">Скидки</li>
            </ul>
        </div>
        <div class="tabs_content">
            <div class="grid_5">
                ...
                <div class="product">
                    ...
                    <div class="info_count count_few">
                        <span>Мало</span>
                        <img src="assets/svg/count_many.svg" alt="" class="svg">
                    </div>
                    <div class="add_in_basket">
